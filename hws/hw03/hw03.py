...
def g_iter(n):
    ...
    "*** YOUR CODE HERE ***"
    i = 1
    current, next_current, next_next_current = 1, 2, 3
    while i < n:
        current, next_current, next_next_current = next_current, next_next_current, 3*current + 2*next_current + next_next_current
        i += 1
    return current
...
def move_stack(n, start, end):
    ...
    move_stack(n-1, start, [i for i in [1, 2, 3] if i != start and i != end][0])
    move_stack(1, start, end)
    move_stack(n-1, [i for i in [1, 2, 3] if i != start and i != end][0], end)
