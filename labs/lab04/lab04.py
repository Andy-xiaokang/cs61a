...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    refer = make_city('refer_city', lat, lon)
    distance_a = distance(refer, city_a)
    distance_b = distance(refer, city_b)
...
def add_chars(w1, w2):
    ...
    if len(w1) == 0:
        return w2
    return add_chars( w1[1:], w2.replace(w1[:1], '', 1) )
